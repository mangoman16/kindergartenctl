                ...
                <div class="profile-picture-controls">
                    ...
                    <form action="<?= url('/user/settings/profile-picture') ?>" method="POST" enctype="multipart/form-data" class="settings-inline-form">
                        ...
                        <label class="btn btn-sm btn-secondary profile-picture-btn">
                            ...
                            <input type="file" name="profile_picture" accept="image/jpeg,image/png,image/gif,image/webp" hidden class="js-auto-submit">
                        </label>
                    </form>
                </div>
            </div>
        ...
        <div class="settings-group-body">
            <?php if (!empty($users)): ?>
                ...
                <div class="settings-group-item settings-group-item-inline">
                    ...
                    <form action="<?= url('/user/settings/delete-user') ?>" method="POST" style="margin:0;" data-confirm="<?= e(__('user.confirm_delete')) ?>">
                        <?= csrfField() ?>
